                    ...
                    <ul id="menu-pricing" class="menu-price">
                        ...
                        @foreach($items as $item)
                            <li class="item" id="{{ $item->category->slug }}">
                                <a href="#">
                                    <img src="{{ asset('uploads/item/'.$item->image) }}" class="img-responsive" alt="Item" style="height: 255px; width: 369px;" >
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, 2018 <a href="#">Food Kitchen.</a> Developed by <a href="">Selim Khan</a> Theme by <a href=""  target="_blank">ThemeWagon</a>
                    </p>
                </div>
            </div>
        </div>
